...
def deep_supervision_scale(targets):
    B, C, H, W=targets.shape
    newtargets=[]
    newtargets.append(targets)
    targetsd4 = torch.nn.functional.interpolate(input=targets, size=(H // 4, W // 4), mode='bicubic',align_corners=False)
    targetsd8 = torch.nn.functional.interpolate(input=targets, size=(H // 8, W // 8),mode='bicubic',align_corners=False)
